...
import ringone from "../Images/1.png";
import ringtwo from "../Images/4.png";
import ringthree from "../Images/6.png";
import ringfour from "../Images/2.png";
import ringfive from "../Images/5.png";
import ringsix from "../Images/7.png";
import ringseven from "../Images/3.png";
...
export default function Section3() {
  ...
  const [selectedOption, setSelectedOption] = useState(1); // Initialize with 1
          ...
          <div className="col-lg-12">
            <div className="select_div">
              <div className="select_opt">
                ...
                {/* {show && <div className="metal_option">Hello Gagan</div>} */}
                ...
                {shape && (
                  <div className="select_shape">
                    <div className="first_row">
                      ...
                      <RxCross1 onClick={() => setshape(false)} />
                    </div>

                    <div className="btn_row">
                      <button
                        className={selectedOption === 1 ? "selected" : ""}
                        onClick={() => handleButtonoption(1)}
                      >
                        {/* <h5>14K</h5> */}
                        <svg
                          viewBox="0 0 40 40"
                      ...
                      <button
                        className={selectedOption === 9 ? "selected" : ""}
                        onClick={() => handleButtonoption(9)}
                      >
                        <svg
                          viewBox="0 0 40 40"
                          fill="none"
                      ...
                      <button
                        className={selectedOption === 10 ? "selected" : ""}
                        onClick={() => handleButtonoption(10)}
                      >
                        <svg
                          viewBox="0 0 40 40"
                          fill="none"
              ...
              <select>
                <option value="volvo">Pricing(low-to-high)</option>
                <option value="saab">Pricing(high-to-low)</option>
                <option value="fiat">Best Selling</option>
              </select>
            </div>
          </div>
        </div>
