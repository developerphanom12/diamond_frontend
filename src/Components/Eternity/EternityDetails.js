...
import onezero from "../../Images/onezero.png";
import onefive from "../../Images/onefive.png";
import twozero from "../../Images/twozero.png";
import threezero from "../../Images/threezero.png";
...
const CaratList = [
  ...
  { value: "1.5", imgUrl: onefive },
  { value: "2.0", imgUrl: twozero },
  { value: "3.0", imgUrl: threezero },
  { value: "3.5", imgUrl: threefive },
];

export default function EternityDetails() {
  ...
  const handleTypeClick = (shapeName, shapeImageUrl) => {
    setSelectedType(shapeName);
    setSelectedTypeImg(shapeImageUrl);
  };
    ...
    <Root>
      <div className="main_wrapper">
        ...
        <div className="des_div">
          ...
          <div className="ring_types mt-4">
            <h4>Approx. Total Carat Weight: {selectedWidth}</h4>
            <div>
              {CaratList &&
                CaratList.map((carat) => (
                  <button
                    key={carat.value}
                    className={`btn_shapes ${
                      selectedWidth.includes(carat.value) ? "selected" : ""
                    }`}
                    onClick={() => handleWidthClick(carat.value)}
                  >
                    <img
                      className="img color_div"
                      src={carat.imgUrl}
                      alt={carat.value}
                    />
                    <p style={{ display: "none" }}>{carat.value}</p>
                  </button>
                ))}
            </div>
          </div>
