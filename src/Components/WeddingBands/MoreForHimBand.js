...
import hammered from "../../Images/hammered.png";
...
const typeList = [
  { value: "Polished", imgUrl: polished },
  { value: "Matte", imgUrl: matte },
  { value: "Hammered", imgUrl: hammered },
];
              ...
              {typeList &&
                typeList.map((type) => (
                  <button
                    key={type.value}
                    className={`btn_shapes ${
                      selectedType.includes(type.value) ? "selected" : ""
                    }`}
                  ...
                  >
                    <img
                      ...
                      alt={type.value}
                    />
                    <p style={{ display: "none" }}>{type.value}</p>
                  </button>
                ))}
            </div>
          </div>
