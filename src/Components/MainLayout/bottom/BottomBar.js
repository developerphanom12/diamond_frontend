...
function BottomBar() {
  ...
  return (
    <Root>
      ...
      >
        <ContainerFluid fluid style={{ backgroundColor: "#fff", padding: "0px" }}>
          <Nav style={{ backgroundColor: "#fff" }}>
            ...
            <div
              ...
              id="graphic"
            >
              <Nav.Link href="#features">Engagement rings</Nav.Link>
              {isListOpen2 && (
                <div className="option_list_list">
                  {/* <ProgrammingTech /> */}
                  fdghdfghfd
            ...
            <div
              ...
              id="graphic"
            >
              <Nav.Link href="#pricing">wedding bands </Nav.Link>
              {isListOpen3 && (
                <div className="option_list_list">
                  {/* <DigitalMarketing /> */}
                  fgfdgd
            ...
            <div
              ...
              id="graphic"
            >
              <Nav.Link href="#pricing">diamonds</Nav.Link>
